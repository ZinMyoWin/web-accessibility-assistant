    ...
    >
        ...
        <Dialog>
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <DialogClose asChild>
                <Button variant="destructive" size="sm" onClick={() => onToast("Scan history cleared")}>
                  Yes, clear history
                </Button>
              </DialogClose>
            </DialogFooter>
      ...
      <div className="flex items-center justify-between gap-4 rounded-md border-[0.5px] border-[var(--high-text)]/20 bg-[var(--high-bg)] p-4">
        <div>
          ...
          <div className="mt-0.5 text-[11px] text-[var(--high-text)]/70">
            Restores all settings to their factory defaults, including API keys
          </div>
        </div>
        <Dialog>
          <DialogTrigger asChild>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                All settings — including API keys, crawl defaults, and notification preferences — will be restored to their factory defaults.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <DialogClose asChild>
              ...
              <DialogClose asChild>
                <Button variant="destructive" size="sm" onClick={() => onToast("Preferences reset to defaults")}>
                  Yes, reset
                </Button>
              </DialogClose>
            </DialogFooter>
